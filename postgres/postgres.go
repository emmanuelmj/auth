...
/* PostgresStorage implements the auth.StorageEngine interface using pgxpool. */
...
func (p *PostgresStorage) ListUsers(ctx context.Context, limit, offset int) ([]auth.User, error) {
