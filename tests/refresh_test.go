...
func TestRefreshTokenGenerateAndValidateWithRedis(t *testing.T) {
	...
	userID := "user_123"
	_ = a.RegisterUser(context.Background(), userID, "password123")
...
func TestRefreshTokenRevokeWithRedis(t *testing.T) {
	...
	userID := "user_456"
	_ = a.RegisterUser(context.Background(), userID, "password456")
	token, _ := a.GenerateRefreshToken(context.Background(), userID)
...
func TestRevokeAllUserRefreshTokensWithRedis(t *testing.T) {
	...
	userID := "user_789"
	_ = a.RegisterUser(context.Background(), userID, "password789")
	token1, _ := a.GenerateRefreshToken(context.Background(), userID)
	token2, _ := a.GenerateRefreshToken(context.Background(), userID)

	_ = a.RegisterUser(context.Background(), "user_other", "password_other")
	otherToken, _ := a.GenerateRefreshToken(context.Background(), "user_other")
	...
	if uid, err := a.ValidateRefreshToken(context.Background(), otherToken); err != nil || uid != "user_other" {
